    ...
    subCategories: [
      {
        ...
        products: [
          ...
          {
            name: 'Dexcom G7 Sample Sensor',
            ndcCode: 'STE-AT-030',
            expirationRange1Price: 60.00,
            expirationRange2Price: 55.00,
            dingReductionPrice: 5.00,
          },
          {
            name: 'Dexcom G7 15 Day Sensor (STP-FT-011)',
            ndcCode: 'STP-FT-011',
            expirationRange1Price: 100.00,
            expirationRange2Price: 95.00,
            dingReductionPrice: 5.00,
          },
          {
            name: 'Dexcom G7 15 Day Sensor Sample (STP-FT-016)',
            ndcCode: 'STP-FT-016',
            expirationRange1Price: 65.00,
            expirationRange2Price: 60.00,
            dingReductionPrice: 5.00,
          },
          {
            name: 'Dexcom G7 Receiver STK-AT-011',
            ndcCode: 'STK-AT-011',
            expirationRange1Price: 130.00,
    ...
    subCategories: [
      {
        ...
        products: [
          ...
          },
          {
            ...
            ndcCode: '57599-0819-00',
            expirationRange1Price: 55.00,
            dingReductionPrice: 5.00,
          },
          {
            name: 'Freestyle Libre 3 Plus 14 Day Sensor',
            ndcCode: '57599-0844-00',
            expirationRange1Price: 65.00,
            expirationRange2Price: 55.00,
            dingReductionPrice: 2.00,
          },
    ...
    subCategories: [
      {
        ...
        products: [
          ...
          {
            name: 'Omnipod 5 (G6/Libre 2 Plus)',
            ndcCode: '08508-3000-42',
            expirationRange1Price: 200.00,
            expirationRange2Price: 190.00,
            dingReductionPrice: 5.00,
          },
          {
            name: 'Omnipod 5 DME (5 pack)',
            ndcCode: '08508-3000-75',
            expirationRange1Price: 200.00,
            expirationRange2Price: 190.00,
            dingReductionPrice: 5.00,
          },
